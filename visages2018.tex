...
\begin{itemize}
    \item Rémi Gribonval, Senior Researcher Scientist at Inria, gave a talk during Brainhack Global: ``Reproducible research — is it worth the effort, and how to ease it?'', April 25, \url{https://videos-rennes.inria.fr/video/ryewCPuCG}.
...
\begin{itemize}
    \item C. Barillot and O.Commowick. ``Objective Evaluation of Multiple Sclerosis Lesion Segmentation using a Data Management and Processing Infrastructure'' - Journées françaises de radiologie - Paris (Oct 2018)~\cite{commowick:inserm-01895603}
...
\XMLaddatt*{type}{sanspuces}
    ...
    \item *TODO*: Pierre-Yves Jonin, Introduction aux méthodes de neuroimagerie pour la recherche en neuropsychologie (3h) Master 2. Université de Poitiers, France.
    \item *TODO*: Pierre-Yves Jonin,Evaluation neuropsychologique à visée diagnostique. Le cas des syndromes démentiels. Master 2 (2 x 6h) Université de Poitiers, France.
    \item *TODO*: Pierre-Yves Jonin,L'exploration neuropsychologique des maladies neurologiques et psychiatriques. 4\`eme \& 5\`ame année de m\'edecine (4h), Universit\'a de Brest, France.
    \item *TODO*: Pierre-Yves Jonin, Neurosciences cognitives de la mémoire humaine. Master 2. 3 heures. Université de Rennes 1, France.
    \item *TODO*: Pierre-Yves Jonin, Les syndromes neuropsychologiques. Licence 3, (16h) Université de Rennes 2, France
    \item *TODO*: Pierre-Yves Jonin, L'approche neuropsychologique du handicap chez les patients cérébro-lésés. Licence 3. Université de Rennes 2.
    \item *TODO*: Pierre-Yves Jonin, Evaluation neuropsychologique à visée diagnostique. Le cas des syndromes démentiels. Master 2. 2 x 6 heures. Université de Rennes 2.
    \item *TODO*: Pierre-Yves Jonin, Méthodologie de la recherche clinique. Master 2. 3 heures. Université de Rennes 2.
    \item *TODO*: Pierre-Yves Jonin, Méthodologie clinique et principes de l’évaluation neuropsychologique à visée diagnostique. Master 2. 3h30. Université de Savoie.
