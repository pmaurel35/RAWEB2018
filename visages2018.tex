...
%%%     \end{itemize}    
    ...
    \begin{itemize}
        \item Brainhack Global Rennes 2018: \url{https://brainhack.irisa.fr}, May 25-26, Rennes, France (Claire Cury).
    \end{itemize}    
...
\begin{itemize}
\XMLaddatt*{type}{sanspuces}
     \item Master: Cédric Meurée, Algorithms and Complexity, 28h, M1, ESIR, France
     \item Master: Corentin Vallée, Machine Learning, 64h, M1, Univ. Rennes, France
     \item Licence: Raphaël Truffet, Génie Logiciel, 24h, L2, ISTIC, France
...
\begin{itemize}
    ...
    \item Village des sciences - Julie Coloigner; Francesca Galassi; Antoine Legouhy; Corentin Vallée: Description of MR modalities and work of VISAGES team to the genreal public, Oct 5-7, Rennes, France. 
\end{itemize}
