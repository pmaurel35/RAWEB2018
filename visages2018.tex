...
%%%     \end{itemize}    
    ...
    \begin{itemize}
        \item Brainhack Global Rennes 2018: \url{https://brainhack.irisa.fr}, May 25-26, Rennes, France (Claire Cury, Mathis Fleury).
    \end{itemize}    
...
\subsection {Scientific Events Selection}
    ...
    *TODO*
    ...
    \begin{itemize}
        \item ISBI (Pierre Maurel)
        \item MICCAI (Francesca Galassi)
