...
\begin{itemize}
   ...
   \item Claire Cury: Blog post ``Anima v3.0 release'' \url{https://team.inria.fr/visages/anima-v3-0-release/}, March, VisAGeS blog.
   \item Olivier Commowick: Blog post ``Workshop Multiple Sclerosis 2018 (UCL, Inria)'' \url{https://team.inria.fr/visages/workshop-multiple-sclerosis-2018-ucl-inria/}, April, VisAGeS blog.
...
\begin{itemize}
    ...
    \item Camille Maumet: Talk to middle school students  (\~100) ``La neuroinformatique'', PRNB, April, Rennes, France.
